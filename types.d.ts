...
export function patchSSLProvider(force:boolean, dialogIfRepairable:boolean): Promise<any>;
...
export type UpdateAPKConstructorArgs = {
   ...
   *  }
   *
   * @see https://github.com/Topdeveloper777/update-apk-new/blob/main/example/android/app/src/main/AndroidManifest.xml
   */
   ...
   */
  needUpdateApp(
    performUpdate: (force: boolean) => Promise<void>,
